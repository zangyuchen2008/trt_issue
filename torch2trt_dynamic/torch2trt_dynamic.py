...
class TRTModule(torch.nn.Module):
    ...
    def forward(self, *inputs):
        ...
        for i, input_name in enumerate(self.input_names):
            ...
            e1_3 = time()
        e1= time()
        # print('part 1 cost time {}'.format(e0-s0))
        ...
        for i, output_name in enumerate(self.output_names):
            ...
            e2_2= time()
        e2= time()
        # print('part 2 cost time {}'.format(e-s))
        s3= time()
        s3_1= time()
        ...
        if len(outputs) == 1:
            outputs = outputs[0]
        e3= time()
        trt_time.append({'part0':{'all': e0-s0,'_1': e0_1 - s0_1, '_2':e0_2-s0_2 },'part1':{'all': e1-s1, '_1': e1_1 - s1_1, '_2':e1_2-s1_2 ,'_3':e1_3-s1_3}
                        ,'part2':{'all':e2-s2,'_1':e2_1-s2_1,'_2': e2_2 -s2_2}
                        ,'part3':{'all':e3-s3,'-1':e3_1 - s3_1}})
        # print('part 1 cost time {},part 2 cost time {},part 3 cost time {}'.format(e0-s0,e1-s1,e2-s2))
        return outputs
