...
class LogitsProcessorList(list):
    ...
    def __call__(self, input_ids: torch.LongTensor, scores: torch.FloatTensor, **kwargs) -> torch.FloatTensor:
        ...
        e= time()
        LogitsProcessorList.Logp_time.append(e-s)
        return scores
...
class MinLengthLogitsProcessor(LogitsProcessor):
    ...
    def __call__(self, input_ids: torch.LongTensor, scores: torch.FloatTensor) -> torch.FloatTensor:
        ...
        e =time()
        MinLengthLogitsProcessor.MinLen_LogP_time.append(e-s)
        return scores
...
class NoRepeatNGramLogitsProcessor(LogitsProcessor):
    ...
    def __call__(self, input_ids: torch.LongTensor, scores: torch.FloatTensor) -> torch.FloatTensor:
        ...
        e2 = time()
        # NoRepeatNGramLogitsProcessor.Norep_Logp_time.append([e0-s0,e1-s1,e2-s2])
        return scores
    ...
    def _calc_banned_ngram_tokens(
        ...
        for idx in range(num_hypos):
            ...
            e1_2_3 = time()
            # NoRepeatNGramLogitsProcessor.Norep_Logp_time.append([e1_2_1-s1_2_1,e1_2_2-s1_2_2,e1_2_3-s1_2_3])
        e1_2 = time()
        e1 = time()
        s2 = time()
        ...
        e3 = time()
        NoRepeatNGramLogitsProcessor.Norep_Logp_time.append([e2-s2,e3-s3])
